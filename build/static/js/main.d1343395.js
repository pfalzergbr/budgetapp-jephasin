/*! For license information please see main.d1343395.js.LICENSE.txt */
!(function () {
  'use strict';
  var e = {
      463: function (e, n, t) {
        ...
        var Va = {
          ...
          enqueueSetState: function (e, n, t) {
            ...
            (a.payload = n),
              ...
              null !== (n = Da(e, a, l)) && (ts(n, e, l, r), Ma(n, e, l));
          },
          ...
          enqueueForceUpdate: function (e, n) {
            ...
            (l.tag = 2),
              ...
              null !== (n = Da(e, l, r)) && (ts(n, e, r, t), Ma(n, e, r));
          },
        };
        ...
        function qu(e, n, t) {
          ...
          switch ((na(n), n.tag)) {
            ...
            case 5:
              ...
              return Qu(n), null;
            case 6:
              if (e && null != n.stateNode) Du(0, n, e.memoizedProps, r);
              else {
        ...
        function vs(e, n) {
          ...
          if ((ka(), (Pi = t), (Ci.current = r), null !== Ti))
            throw Error(a(261));
        ...
        function Hs(e, n, t, r) {
          ...
          return (
            ...
            null !== (e = Da(l, n, o)) && (ts(e, l, o, a), Ma(e, l, o)),
            o
          );
        }
        function Ws(e) {
  ...
  !(function () {
    ...
    var c = t(184),
        ...
        switch (n.type) {
          case 'ADD_EXPENSE':
            return s(
              s({}, e),
              {},
              { expenses: [].concat(o(e.expenses), [n.payload]) }
            );
          case 'DELETE_EXP':
            return s(
              s({}, e),
              {},
              {
                expenses: e.expenses.filter(function (e) {
                  return e.id !== n.payload;
                }),
              }
            );
          case 'UPDATE_BUDGET':
            return s(s({}, e), {}, { budget: n.payload });
          default:
            return e;
        }
      },
      ...
      p = (0, e.createContext)(),
      m = function (n) {
        var t = a((0, e.useReducer)(f, d), 2),
          r = t[0],
          l = t[1];
        return (0, c.jsx)(p.Provider, {
          value: { budget: r.budget, expenses: r.expenses, dispatch: l },
          children: n.children,
        });
      },
      h = function () {
        var n = (0, e.useContext)(p),
          t = n.budget,
          r = n.dispatch,
          l = a((0, e.useState)(t), 2),
          o = l[0],
          u = l[1],
          i = a((0, e.useState)(o), 2),
          s = i[0],
          f = i[1],
          d = a((0, e.useState)('budget'), 2),
          m = d[0],
          h = d[1],
          v = a((0, e.useState)('budget'), 2),
          g = v[0],
          y = v[1],
          b = a((0, e.useState)('btn btn-primary'), 2),
          w = b[0],
          k = b[1];
        return (0, c.jsxs)('div', {
          ...
          children: [
            ...
            (0, c.jsx)('span', {
              ...
              children: (0, c.jsx)('button', {
                className: w,
                onClick: function () {
                  f(!0), h(''), k('budget'), y('btn btn-primary');
                },
                children: 'Edit',
              }),
            }),
              ...
              children: (0, c.jsx)('button', {
                ...
                onClick: function (e) {
                  h('budget'),
                    ...
                    y('budget'),
                    e.preventDefault(),
                    r({ type: 'UPDATE_BUDGET', payload: o });
                },
                children: 'Save',
              }),
            }),
      ...
      v = function () {
        var n = (0, e.useContext)(p),
          t = n.expenses,
          r = n.budget,
          l = t.reduce(function (e, n) {
            return e + n.theCost;
          }, 0),
          a = l < r ? 'alert-success' : 'alert-danger';
        return (0, c.jsx)('div', {
          className: 'alert '.concat(a),
          children: (0, c.jsxs)('span', { children: ['Remaining: $', r - l] }),
        });
      },
      g = function () {
        var n = (0, e.useContext)(p).expenses.reduce(function (e, n) {
          return e + n.theCost;
        }, 0);
        return (0, c.jsx)('div', {
          className: 'alert alert-primary',
          children: (0, c.jsxs)('span', { children: ['Spent: $', n] }),
        });
      },
      y = {
        color: void 0,
      ...
      b = e.createContext && e.createContext(y),
      w = function () {
        return (
          (w =
            Object.assign ||
    ...
    function S(n) {
      return (
        n &&
        n.map(function (n, t) {
          return e.createElement(n.tag, w({ key: t }, n.attr), S(n.child));
        })
      );
    }
    function x(n) {
      return function (t) {
        return e.createElement(E, w({ attr: w({}, n.attr) }, t), S(n.child));
      };
    }
    function E(n) {
      var t = function (t) {
        ...
        return (
          ...
          e.createElement(
            ...
            w(
              ...
              {
                className: r,
                style: w(w({ color: n.color || t.color }, t.style), n.style),
                height: i,
                width: i,
      ...
      return void 0 !== b
        ? e.createElement(b.Consumer, null, function (e) {
            return t(e);
          })
        : t(y);
    }
    ...
    var _,
      ...
      P = function () {
        var n = (0, e.useContext)(p).expenses;
        return (0, c.jsx)('ul', {
          className: 'list-group',
          children: n.map(function (e) {
            return (0, c.jsx)(N, { id: e.id, name: e.name, cost: e.theCost });
          }),
        });
      },
      z = new Uint8Array(16);
    ...
    for (
      ...
      R.push((D + 256).toString(16).substr(1));
    var M = function (e) {
      var n =
    ...
    var F = function (e, n, t) {
      ...
      I = function () {
        var n = (0, e.useContext)(p).dispatch,
          t = a((0, e.useState)(''), 2),
          r = t[0],
          l = t[1],
          o = a((0, e.useState)(''), 2),
        ...
        return (0, c.jsx)('form', {
          onSubmit: function (e) {
            e.preventDefault();
            var t = { id: F(), name: r, theCost: parseInt(u) };
            n({ type: 'ADD_EXPENSE', payload: t }), l(''), i('');
          },
          children: (0, c.jsxs)('div', {
            ...
            children: [
              (0, c.jsxs)('div', {
                className: 'col-sm',
                children: [
                  (0, c.jsx)('label', { form: 'name', children: 'Name' }),
                  (0, c.jsx)('input', {
                    required: !0,
                    type: 'text',
              ...
              (0, c.jsxs)('div', {
                className: 'col-sm',
                children: [
                  (0, c.jsx)('label', { form: 'cost', children: 'Cost' }),
                  (0, c.jsx)('input', {
                    required: !0,
                    type: 'text',
                    className: 'form-control',
    ...
    var j = function () {
      return (0, c.jsx)(m, {
        children: (0, c.jsxs)('div', {
          className: 'container',
          children: [
            (0, c.jsx)('h1', { className: 'mt-3', children: 'Budget Planner' }),
            (0, c.jsxs)('div', {
              className: 'row mt-3',
              children: [
                (0, c.jsx)('div', {
                ...
                (0, c.jsx)('h3', { className: 'mt-3', children: 'Expenses' }),
              ],
            }),
            (0, c.jsx)('div', {
              className: 'row mt-3',
            ...
            (0, c.jsx)('h3', { className: 'mt-3', children: 'Add Expense' }),
            (0, c.jsx)('div', {
              className: 'mt-3',
              children: (0, c.jsx)('div', {
                className: 'col-sm',
    ...
    n.createRoot(document.getElementById('root')).render(
      (0, c.jsx)(e.StrictMode, { children: (0, c.jsx)(j, {}) })
    );
  })();
})();
//# sourceMappingURL=main.d1343395.js.map
